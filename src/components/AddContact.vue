            ...
            if(!this.nullOrRequired){
              ...
              this.$swal({
                ...
                if (result.isConfirmed){
                  ...
                  //transfere obj
                  this.$emit('addNewContact',userInput)
                  return[this.contact.name=null,this.contact.age=null,this.contact.email=null,this.contact.job=null,this.contact.phone=null,this.contact.description='',this.contact.location='']
